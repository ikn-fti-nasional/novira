...
<Card.Root class="border-border/80 shadow-md">
	<Card.Header class="flex flex-row flex-wrap items-center justify-between gap-2 space-y-0 pb-3">
		<div class="min-w-0">
			<div class="flex flex-wrap items-center gap-2">
				...
				<Badge variant="outline" class="border-emerald-500/40 text-emerald-700 dark:text-emerald-400 text-[10px]">
	...
	<Card.Content class="p-0">
		...
		<div class="relative h-[320px] w-full overflow-hidden bg-slate-950 text-white shadow-inner">
			<div class="absolute inset-0 opacity-20 bg-[linear-gradient(to_right,#1e293b_1px,transparent_1px),linear-gradient(to_bottom,#1e293b_1px,transparent_1px)] bg-[size:24px_24px]"></div>

			<svg class="absolute inset-0 h-full w-full opacity-30" xmlns="http://www.w3.org/2000/svg">
				<path d="M 0 100 Q 150 140 300 120 T 600 180 T 900 150" stroke="#10b981" stroke-width="4" fill="none" />
				<path d="M 120 0 Q 160 160 220 320" stroke="#3b82f6" stroke-width="3" fill="none" />
				<path d="M 450 0 Q 400 150 480 320" stroke="#f59e0b" stroke-width="3" fill="none" opacity="0.6" />
			...
			<div class="absolute top-[35%] left-[38%] transform -translate-x-1/2 -translate-y-1/2 group cursor-pointer">
				<div class="relative flex items-center justify-center">
					<span class="absolute size-8 animate-ping rounded-full bg-red-500/40"></span>
					<div class="flex size-7 items-center justify-center rounded-full bg-red-600 shadow-lg text-white font-bold text-xs">
						<MapPinIcon class="size-4" />
					</div>
				</div>
				<div class="absolute top-8 left-1/2 transform -translate-x-1/2 whitespace-nowrap rounded bg-slate-900/90 border border-red-500/40 px-2 py-1 text-[10px] text-white shadow-md">
			...
			<div class="absolute top-[52%] left-[62%] transform -translate-x-1/2 -translate-y-1/2 group cursor-pointer">
				<div class="relative flex items-center justify-center">
					<div class="flex size-6 items-center justify-center rounded-full bg-amber-500 shadow-lg text-slate-950 font-bold text-xs">
						<MapPinIcon class="size-3.5" />
					</div>
				</div>
				<div class="absolute top-7 left-1/2 transform -translate-x-1/2 whitespace-nowrap rounded bg-slate-900/90 border border-amber-500/40 px-2 py-1 text-[10px] text-white shadow-md">
			...
			<div class="absolute top-[25%] left-[22%] transform -translate-x-1/2 -translate-y-1/2 group cursor-pointer">
				<div class="relative flex items-center justify-center">
					<div class="flex size-5 items-center justify-center rounded-full bg-emerald-600 shadow-lg text-white text-[10px]">
						<NavigationIcon class="size-3" />
					</div>
				</div>
				<div class="absolute top-6 left-1/2 transform -translate-x-1/2 whitespace-nowrap rounded bg-slate-900/90 border border-emerald-500/40 px-2 py-1 text-[10px] text-white shadow-md">
			...
			<!-- Legenda Peta -->
			<div class="absolute bottom-3 left-3 rounded-lg border border-slate-800 bg-slate-900/90 p-2.5 text-[10px] backdrop-blur-xs">
				<p class="mb-1.5 font-bold uppercase tracking-wider text-slate-400">Keterangan Tingkat Keparahan</p>
