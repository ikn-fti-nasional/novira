...
export function triggerPdfReportPrint(
	...
	import("jspdf").then(async ({ default: jsPDF }) => {
		...
		const orientation: "landscape" | "portrait" = colCount > 8 ? "landscape" : colCount > 5 ? "landscape" : "portrait";
		...
		(autoTable as any)(doc, {
			...
			headStyles: { fillColor: [5, 95, 70], textColor: 255, fontStyle: "bold", fontSize: fontSize },
